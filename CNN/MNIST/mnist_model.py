...
def he_normal(out_shape, fan_in):
    ...
    #https://medium.com/analytics-vidhya/simple-cnn-using-numpy-part-ii-convolution-operation-b8c5a02b0844
    #https://towardsdatascience.com/building-a-convolutional-neural-network-from-scratch-using-numpy-a22808a00a40
    #https://wikidocs.net/196917
    #https://medium.com/analytics-vidhya/neural-network-mnist-classifier-from-scratch-using-numpy-library-94bbcfed7eae#b7ab
    #https://www.chenshiyu.top/blog/2019/05/31/Implementation-of-CNN-by-Numpy/
